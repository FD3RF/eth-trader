...
# ==========================================
# 🔄 5. 核心刷新循环 (解决 DuplicateKey 及缩进报错)
# ==========================================
async def update_terminal():
    while True:
        ...
        with matrix_ph.container():
            ...
            # 关键修复：使用 width="stretch" 适配最新版本，并使用动态 ID
        ...
        with log_ph.container():
            ...
            try:
                ...
                # 关键修复：统一使用 width="stretch" 消除日志报警
